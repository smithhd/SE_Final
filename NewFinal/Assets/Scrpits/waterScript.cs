//Hunter Smith
//waterScript class lays water tiles based off neighboring tiles
//part taken from InScope Studios tutorial
...
public class waterScript : Tile
{
    ...
    //check neighbors and refreshes tile based on neighboring tiles
    //param position is the posistion of the current tile
    //param tilemap is the world tilemap
    ...
    //taken from InScope Studios tutorial
    //get information about the tile and its neighbors
    //param location is the location of the tile
    //param tilemap is the world tilemap
    //param tiledata is information about the tiles nieghbors
    ...
    public static void CreateWaterTile()
    {
        ...
        AssetDatabase.CreateAsset(ScriptableObject.CreateInstance<waterScript>(), path);
    }
